...
class MSCOCO_Dataset(Dataset):
    def __init__(self, args, image_root, annFile_root, preprocess, tokenizer=None, ids=None, subset='train', logger=None):
        ...
        self.image_name = [os.path.join(image_root, 'COCO_2014_' + str(id).zfill(12) + '.jpg') for id in self.images_id]
        self.texts  = tokenizer(self.captions, truncate=True)
